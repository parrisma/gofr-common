...
echo "======================================================================="
echo "Building Open WebUI Dev Docker image"
echo "======================================================================="
echo "Image: ${IMAGE_NAME}:dev"
echo "Context: ${COMMON_ROOT}"
echo "Dockerfile: ${COMMON_ROOT}/docker/openwebui/Dockerfile.dev"
echo ""

cd "$COMMON_ROOT"
ensure_base_image_if_needed "docker/openwebui/Dockerfile.dev"
docker build \
    ${NO_CACHE} \
    -f docker/openwebui/Dockerfile.dev \
    -t "${IMAGE_NAME}:dev" \
    .
