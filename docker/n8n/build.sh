...
echo "======================================================================="
echo "Building n8n Dev Docker image"
echo "======================================================================="
echo "Image: ${IMAGE_NAME}:dev"
echo "Context: ${COMMON_ROOT}"
echo "Dockerfile: ${COMMON_ROOT}/docker/n8n/Dockerfile.dev"
echo ""

cd "$COMMON_ROOT"
ensure_base_image_if_needed "docker/n8n/Dockerfile.dev"
docker build \
    ${NO_CACHE} \
    -f docker/n8n/Dockerfile.dev \
    -t "${IMAGE_NAME}:dev" \
    .
